...
1, where temperature at the center of a cell is \textit{T}\textit{\scriptsize{}P},
and \textit{T}\textit{\scriptsize{}R} e \textit{T}\textit{\scriptsize{}L}
is temperature at the border between cells, right and left. Integrating
Equation 3 over a cell volume, and considering the rate of accumulation
over the volume \textit{V} equal to the flow across the surfaces of
the control volume, Equation (6), where \textit{n} is the unit normal
vector pointing out of the control volume and \textit{A} is the cross
...
right face \textit{r} minux the flux entering the left face \textit{l}
in Figure (1)
...
is dicretized in terms of the temperature at the cell centers, where
...
\noindent An individual set of equations is made for each cell.
